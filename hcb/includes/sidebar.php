<?php
// Reusable Sidebar Component for HCB Pages
...
<div class="sidebar">
    ...
    <div class="sidebar-menu">
        ...
        <a href="applications.php" class="menu-item <?php echo $current_page == 'applications.php' || strpos($current_page, 'application') !== false ? 'active' : ''; ?>">
