...
if (isset($_POST['btnRegister'])) {
    ...
    $insert_tourist = mysqli_query($conn, "INSERT INTO tbl_tourist (tourist_id, firstname, middlename, lastname, gender, email, contact_no, status_id, date_added)
      VALUES ('$tourist_id', '$firstname', '$middlename', '$lastname', '$gender', '$email', '$contact_no', 
    ...
    if ($insert_tourist) {
      ...
      if ($insert_tourist_acc) {
        ...
        mysqli_query($conn, "DELETE FROM tbl_tourist WHERE tourist_id = '$tourist_id'");
        mysqli_query($conn, "DELETE FROM tbl_useraccount WHERE useraccount_id = '$useraccount_id'");
  ...
  <div class="register-container">
    <div class="register-card">
      ...
      <div class="links">
        ...
        <div class="link-item">
          <i class="fas fa-building"></i> <a href="company.php">Register as Business Company</a>
        </div>
      </div>
    </div>
